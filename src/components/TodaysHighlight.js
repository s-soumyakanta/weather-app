...
const TodaysHighlight = () => {
  ...
  return (
    <>
   <div className="mainDiv  mt-6 md:h-96  md:w-full rounded-2xl   bg-white bg-opacity-60  shadow-sm dark:bg-gray-800 ">
    ...
    <div className="bottomMainDiv space-y-8 p-4 md:space-y-3 md:h-[94%] md:flex md:flex-col md:justify-between">
      <div className="bigDivs space-y-3  md:flex md:space-y-0 md:space-x-3 md:h-4/6 ">
        <div className="div1 h-64   rounded-2xl md:w-1/3 md:h-auto  bg-white bg-opacity-80  shadow-sm dark:bg-gray-700 ">
        ...
        <div className="div2 h-64  rounded-2xl md:w-1/3 md:h-auto  bg-white bg-opacity-80  shadow-sm dark:bg-gray-700 ">
        <div className='h-full'>
        ...
        <div className="div3  rounded-2xl md:w-1/3 md:h-auto  bg-white bg-opacity-80  shadow-sm dark:bg-gray-700 ">
        <div className='h-full'>
            <div className='h-1/6  flex items-center pl-4'>
      ...
      <div className="smallDivs space-y-3  md:space-y-0 md:space-x-3 md:h-2/6 md:flex md:w-full  ">
        ...
        <div className="div1 h-28   rounded-2xl md:w-1/3 md:h-auto  bg-white bg-opacity-80  shadow-sm dark:bg-gray-700 ">
        <div className='h-full flex mx-4 md:mx-2'>
            <div className='w-3/6 flex flex-col justify-between my-2 '>
