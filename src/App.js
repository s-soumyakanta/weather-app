    ...
    return(
      <>
        ...
        <div className='w-16 h-16 bg-blue-700
                    shadow-sm sticky bottom-0 right-0 md:absolute  rounded-full  z-20  flex justify-center  items-center text-white cursor-pointer' onClick={geoLocation}>
...
<SkeletonUI />
  ...
  return (
    <>
      <div className='h-[100vh]   p-4 space-y-1 relative bg-slate-400 dark:bg-gray-900 dark:text-gray-50 overflow-y-scroll hide-scroll-bar'>
